...
def test_text_normalizer():
    std = EnglishTextNormalizer(remove_disfluencies=True)
...
def test_disfluencies_mapping():
    std = EnglishTextNormalizer(remove_disfluencies=False)
    assert std("Ahhhhhhhhh") == "ah"
    assert std("Hmmmm") == "hmm"
    assert std("Ehhhhh?") == "eh"
    assert std("ummmm") == "um"
    assert std("mmmmm") == "mm"
    assert std("uhhh") == "uh"
